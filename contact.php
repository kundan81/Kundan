...
<article class="post">
  ...
  {
	  $id='';
 $sql="INSERT INTO trp_contact (contact_name, contact_email, contact_number, contact_subject,
  contact_message) VALUES ('$_POST[name]','$_POST[email]','$_POST[contact]','$_POST[subject]','$_POST[message]')";
