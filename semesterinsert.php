...
{
mysql_query("UPDATE ".$trp_rp."semester SET semester_name='$_POST[semestername]', semester_comment='$_POST[semestercom]', batch_year='$_POST[batchyr]' WHERE semester_id = '$_POST[semester_id]'");
...
<form name="form1" method="post" action="" id="formID">
  <p>
    <label for="textfield">Batch ID</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="text" name="batchid" id="textfield" class="validate[required] text-input" value="<?php echo $batchid; ?>" readonly>
  </p>
  <p>
...
<?php echo $error ?>
<p>&nbsp;</p>
<a href='semester.php'><img src="images/back.png"></a>
 </section>
</article>
