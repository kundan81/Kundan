...
WHERE admin_email='$_POST[uid]'  and password='$_POST[pwd]'");
...
<article class="post">
  ...
  <form action="" method="post" class="form">
		...
		<p class="textfield"><a href="attendence.php">Attendence</a></p><hr />
		<p class="textfield"><a href="marks.php">Marks</a></p><hr />		
